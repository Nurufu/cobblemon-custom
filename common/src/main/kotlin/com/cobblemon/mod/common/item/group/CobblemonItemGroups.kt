...
object CobblemonItemGroups {
    ...
    private fun blockEntries(displayContext: DisplayContext, entries: Entries) {
        ...
        entries.add(CobblemonItems.BLACK_APRICORN_LOG)
        entries.add(CobblemonItems.BLACK_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_BLACK_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_BLACK_APRICORN_WOOD)
        entries.add(CobblemonItems.BLACK_APRICORN_PLANKS)
        entries.add(CobblemonItems.BLACK_APRICORN_STAIRS)
        entries.add(CobblemonItems.BLACK_APRICORN_SLAB)
        entries.add(CobblemonItems.BLACK_APRICORN_FENCE)
        entries.add(CobblemonItems.BLACK_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.BLACK_APRICORN_DOOR)
        entries.add(CobblemonItems.BLACK_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.BLACK_APRICORN_BUTTON)
        entries.add(CobblemonItems.BLACK_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.BLACK_APRICORN_SIGN)
        entries.add(CobblemonItems.BLACK_APRICORN_HANGING_SIGN)

        entries.add(CobblemonItems.BLUE_APRICORN_LOG)
        entries.add(CobblemonItems.BLUE_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_BLUE_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_BLUE_APRICORN_WOOD)
        entries.add(CobblemonItems.BLUE_APRICORN_PLANKS)
        entries.add(CobblemonItems.BLUE_APRICORN_STAIRS)
        entries.add(CobblemonItems.BLUE_APRICORN_SLAB)
        entries.add(CobblemonItems.BLUE_APRICORN_FENCE)
        entries.add(CobblemonItems.BLUE_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.BLUE_APRICORN_DOOR)
        entries.add(CobblemonItems.BLUE_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.BLUE_APRICORN_BUTTON)
        entries.add(CobblemonItems.BLUE_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.BLUE_APRICORN_SIGN)
        entries.add(CobblemonItems.BLUE_APRICORN_HANGING_SIGN)

        entries.add(CobblemonItems.GREEN_APRICORN_LOG)
        entries.add(CobblemonItems.GREEN_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_GREEN_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_GREEN_APRICORN_WOOD)
        entries.add(CobblemonItems.GREEN_APRICORN_PLANKS)
        entries.add(CobblemonItems.GREEN_APRICORN_STAIRS)
        entries.add(CobblemonItems.GREEN_APRICORN_SLAB)
        entries.add(CobblemonItems.GREEN_APRICORN_FENCE)
        entries.add(CobblemonItems.GREEN_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.GREEN_APRICORN_DOOR)
        entries.add(CobblemonItems.GREEN_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.GREEN_APRICORN_BUTTON)
        entries.add(CobblemonItems.GREEN_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.GREEN_APRICORN_SIGN)
        entries.add(CobblemonItems.GREEN_APRICORN_HANGING_SIGN)

        entries.add(CobblemonItems.PINK_APRICORN_LOG)
        entries.add(CobblemonItems.PINK_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_PINK_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_PINK_APRICORN_WOOD)
        entries.add(CobblemonItems.PINK_APRICORN_PLANKS)
        entries.add(CobblemonItems.PINK_APRICORN_STAIRS)
        entries.add(CobblemonItems.PINK_APRICORN_SLAB)
        entries.add(CobblemonItems.PINK_APRICORN_FENCE)
        entries.add(CobblemonItems.PINK_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.PINK_APRICORN_DOOR)
        entries.add(CobblemonItems.PINK_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.PINK_APRICORN_BUTTON)
        entries.add(CobblemonItems.PINK_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.PINK_APRICORN_SIGN)
        entries.add(CobblemonItems.PINK_APRICORN_HANGING_SIGN)

        entries.add(CobblemonItems.RED_APRICORN_LOG)
        entries.add(CobblemonItems.RED_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_RED_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_RED_APRICORN_WOOD)
        entries.add(CobblemonItems.RED_APRICORN_PLANKS)
        entries.add(CobblemonItems.RED_APRICORN_STAIRS)
        entries.add(CobblemonItems.RED_APRICORN_SLAB)
        entries.add(CobblemonItems.RED_APRICORN_FENCE)
        entries.add(CobblemonItems.RED_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.RED_APRICORN_DOOR)
        entries.add(CobblemonItems.RED_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.RED_APRICORN_BUTTON)
        entries.add(CobblemonItems.RED_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.RED_APRICORN_SIGN)
        entries.add(CobblemonItems.RED_APRICORN_HANGING_SIGN)

        entries.add(CobblemonItems.WHITE_APRICORN_LOG)
        entries.add(CobblemonItems.WHITE_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_WHITE_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_WHITE_APRICORN_WOOD)
        entries.add(CobblemonItems.WHITE_APRICORN_PLANKS)
        entries.add(CobblemonItems.WHITE_APRICORN_STAIRS)
        entries.add(CobblemonItems.WHITE_APRICORN_SLAB)
        entries.add(CobblemonItems.WHITE_APRICORN_FENCE)
        entries.add(CobblemonItems.WHITE_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.WHITE_APRICORN_DOOR)
        entries.add(CobblemonItems.WHITE_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.WHITE_APRICORN_BUTTON)
        entries.add(CobblemonItems.WHITE_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.WHITE_APRICORN_SIGN)
        entries.add(CobblemonItems.WHITE_APRICORN_HANGING_SIGN)

        entries.add(CobblemonItems.YELLOW_APRICORN_LOG)
        entries.add(CobblemonItems.YELLOW_APRICORN_WOOD)
        entries.add(CobblemonItems.STRIPPED_YELLOW_APRICORN_LOG)
        entries.add(CobblemonItems.STRIPPED_YELLOW_APRICORN_WOOD)
        entries.add(CobblemonItems.YELLOW_APRICORN_PLANKS)
        entries.add(CobblemonItems.YELLOW_APRICORN_STAIRS)
        entries.add(CobblemonItems.YELLOW_APRICORN_SLAB)
        entries.add(CobblemonItems.YELLOW_APRICORN_FENCE)
        entries.add(CobblemonItems.YELLOW_APRICORN_FENCE_GATE)
        entries.add(CobblemonItems.YELLOW_APRICORN_DOOR)
        entries.add(CobblemonItems.YELLOW_APRICORN_TRAPDOOR)
        entries.add(CobblemonItems.YELLOW_APRICORN_BUTTON)
        entries.add(CobblemonItems.YELLOW_APRICORN_PRESSURE_PLATE)
        entries.add(CobblemonItems.YELLOW_APRICORN_SIGN)
        entries.add(CobblemonItems.YELLOW_APRICORN_HANGING_SIGN)
    ...
    private fun evolutionItemEntries(displayContext: DisplayContext, entries: Entries) {
        ...
        entries.add(CobblemonItems.MEGA_STONE_X)
        entries.add(CobblemonItems.MEGA_STONE_Y)
        entries.add(CobblemonItems.MEGA_STONE_Z)
