...
//}
//
//fun PacketByteBuf.writeItemStack(itemStack: ItemStack) { // TODO (techdaan): why was itemStack optional?
//    ItemStack.OPTIONAL_STREAM_CODEC.encode(this, itemStack)
//}
//
//fun PacketByteBuf.readText(): Component {
//    return ComponentSerialization.STREAM_CODEC.decode(this)
//}
//
//fun PacketByteBuf.writeText(text: Component) { // TODO (techdaan): why was text optional?
...
fun <T> PacketByteBuf.readList(reader: (PacketByteBuf) -> T): List<T> = readCollection(Lists::newArrayListWithCapacity, reader)
