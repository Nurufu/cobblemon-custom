...
object CobblemonBlockTags {
    ...
    @JvmField val BLACK_APRICORN_LOGS = createTag("black_pricorn_logs")
    @JvmField val BLUE_APRICORN_LOGS = createTag("blue_apricorn_logs")
    @JvmField val GREEN_APRICORN_LOGS = createTag("green_apricorn_logs")
    @JvmField val PINK_APRICORN_LOGS = createTag("pink_apricorn_logs")
    @JvmField val RED_APRICORN_LOGS = createTag("red_apricorn_logs")
    @JvmField val WHITE_APRICORN_LOGS = createTag("white_apricorn_logs")
    @JvmField val YELLOW_APRICORN_LOGS = createTag("yellow_apricorn_logs")
