        ...
        when (targetedEntity) {
            ...
            is ServerPlayerEntity -> {
                ...
                val existingChallenge = BattleRegistry.pvpChallenges[targetedEntity.uuid]
                    //?: BattleRegistry.pvpChallenges[BattleRegistry.playerToTeam[targetedEntity.uuid]?.teamID]
...
//                            }
//
//                            val leadPokemon = players.mapNotNull { ServerPlayerEntityEntity ->
//                                ServerPlayerEntityEntity.party().first().uuid
//                            }
//
...
//                        } else {
                        ...
                        BattleBuilder.pvp1v1(
                            ...
                            targetedEntity,
                            leadingPokemon,
                            existingChallengePokemon,
                            battleFormat
                        ).ifErrored { it.sendTo(player) { it.red() }; it.sendTo(targetedEntity) { it.red() } }
