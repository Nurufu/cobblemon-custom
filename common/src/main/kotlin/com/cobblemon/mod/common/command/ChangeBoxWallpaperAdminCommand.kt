...
object ChangeBoxWallpaperAdminCommand {
    ...
    fun register(dispatcher: CommandDispatcher<ServerCommandSource>) {
        dispatcher.register(CommandManager.literal("adminchangewallpaper")
            .permission(CobblemonPermissions.CHANGE_WALLPAPER_ADMIN)
