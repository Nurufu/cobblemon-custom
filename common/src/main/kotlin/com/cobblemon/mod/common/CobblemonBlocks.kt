 ...
 @JvmField
    ...
    init {
        ...
        arrayOf(
            ...
            Triple(BLACK_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_BLACK_APRICORN_LOG, 5, 5),
            Triple(BLACK_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_BLACK_APRICORN_WOOD, 5, 5),
            Triple(BLACK_APRICORN_PLANKS, 5, 20),
            Triple(BLACK_APRICORN_FENCE, 5, 20),
            Triple(BLACK_APRICORN_FENCE_GATE, 5, 20),
            Triple(BLACK_APRICORN_SLAB, 5, 20),
            Triple(BLACK_APRICORN_STAIRS, 5, 20),
            Triple(GREEN_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_GREEN_APRICORN_LOG, 5, 5),
            Triple(GREEN_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_GREEN_APRICORN_WOOD, 5, 5),
            Triple(GREEN_APRICORN_PLANKS, 5, 20),
            Triple(GREEN_APRICORN_FENCE, 5, 20),
            Triple(GREEN_APRICORN_FENCE_GATE, 5, 20),
            Triple(GREEN_APRICORN_SLAB, 5, 20),
            Triple(GREEN_APRICORN_STAIRS, 5, 20),
            Triple(BLUE_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_BLUE_APRICORN_LOG, 5, 5),
            Triple(BLUE_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_BLUE_APRICORN_WOOD, 5, 5),
            Triple(BLUE_APRICORN_PLANKS, 5, 20),
            Triple(BLUE_APRICORN_FENCE, 5, 20),
            Triple(BLUE_APRICORN_FENCE_GATE, 5, 20),
            Triple(BLUE_APRICORN_SLAB, 5, 20),
            Triple(BLUE_APRICORN_STAIRS, 5, 20),
            Triple(PINK_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_PINK_APRICORN_LOG, 5, 5),
            Triple(PINK_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_PINK_APRICORN_WOOD, 5, 5),
            Triple(PINK_APRICORN_PLANKS, 5, 20),
            Triple(PINK_APRICORN_FENCE, 5, 20),
            Triple(PINK_APRICORN_FENCE_GATE, 5, 20),
            Triple(PINK_APRICORN_SLAB, 5, 20),
            Triple(PINK_APRICORN_STAIRS, 5, 20),
            Triple(RED_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_RED_APRICORN_LOG, 5, 5),
            Triple(RED_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_RED_APRICORN_WOOD, 5, 5),
            Triple(RED_APRICORN_PLANKS, 5, 20),
            Triple(RED_APRICORN_FENCE, 5, 20),
            Triple(RED_APRICORN_FENCE_GATE, 5, 20),
            Triple(RED_APRICORN_SLAB, 5, 20),
            Triple(RED_APRICORN_STAIRS, 5, 20),
            Triple(WHITE_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_WHITE_APRICORN_LOG, 5, 5),
            Triple(WHITE_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_WHITE_APRICORN_WOOD, 5, 5),
            Triple(WHITE_APRICORN_PLANKS, 5, 20),
            Triple(WHITE_APRICORN_FENCE, 5, 20),
            Triple(WHITE_APRICORN_FENCE_GATE, 5, 20),
            Triple(WHITE_APRICORN_SLAB, 5, 20),
            Triple(WHITE_APRICORN_STAIRS, 5, 20),
            Triple(YELLOW_APRICORN_LOG, 5, 5),
            Triple(STRIPPED_YELLOW_APRICORN_LOG, 5, 5),
            Triple(YELLOW_APRICORN_WOOD, 5, 5),
            Triple(STRIPPED_YELLOW_APRICORN_WOOD, 5, 5),
            Triple(YELLOW_APRICORN_PLANKS, 5, 20),
            Triple(YELLOW_APRICORN_FENCE, 5, 20),
            Triple(YELLOW_APRICORN_FENCE_GATE, 5, 20),
            Triple(YELLOW_APRICORN_SLAB, 5, 20),
            Triple(YELLOW_APRICORN_STAIRS, 5, 20)
