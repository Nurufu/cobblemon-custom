...
class RequestChangePCBoxWallpaperPacket internal constructor(val storeID: UUID, val boxNumber: Int, val wallpaper: Identifier) : NetworkPacket<RequestChangePCBoxWallpaperPacket>, UnsplittablePacket {
    ...
    companion object {
        ...
        fun decode(buffer: PacketByteBuf): RequestChangePCBoxWallpaperPacket {
