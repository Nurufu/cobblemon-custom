...
class DratiniModel(root: ModelPart) : PokemonPosableModel(root), HeadedFrame {
    ...
    lateinit var water_idle: Pose
    lateinit var water_swim: Pose
    lateinit var sleep: Pose
    lateinit var water_sleep: Pose
    lateinit var surface_swim: Pose

    override val cryAnimation = CryProvider { bedrockStateful("dratini", "cry") }
