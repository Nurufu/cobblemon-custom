...
class IllusionEffect(
    ...
    override fun revert(entity: PokemonEntity, future: CompletableFuture<PokemonEntity>) {
        ...
        afterOnServer(seconds = 1.0F) {
            entity.cry()
            if (entity.pokemon.shiny) SpawnSnowstormEntityParticlePacket(cobblemonResource("shiny_ring"), entity.id,listOf("shiny_particles","middle")).sendToPlayersAround(entity.x,entity.y,entity.z,64.0,entity.world.registryKey)
            future.complete(entity)
        }
    }
